    ...
    <form id="form1" runat="server">
        <div>
            ...
            <div>
                ...
                <asp:Substitution ID="SstMain" runat="server" MethodName="GetCurrentName" />
             </div>
            <div>
                <asp:Localize ID="Localize1" runat="server" Text="안녕하세요"></asp:Localize><br />
                <asp:Localize ID="LblLocal1" runat="server" Text="<hr /><b>안녕하세요</b>" Mode="Transform"></asp:Localize><br />
            </div>
        </div>
    </form>
</body>
