...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:SqlDataSource ID="SdsMemoName" runat="server" ConnectionString="<%$ ConnectionStrings:TestDBConnectionString %>"
                SelectCommand="SELECT [Num], [Name] FROM [Memos]"></asp:SqlDataSource>
                ...
                <Series>
                    <asp:Series Name="Series1">
                        <Points>
                            ...
                            <asp:DataPoint AxisLabel="수학" YValues="90.0" />
                        </Points>
                    </asp:Series>
                </Series>
                <ChartAreas>
